module DocumentGenerator
    ...
    def generate_document_for_settlement(settlement)
        ...
        pdf.move_down 20
        pdf.text "#{settlement.adjuster.organization.business_name}", align: :center, style: :bold
        pdf.move_down 15
