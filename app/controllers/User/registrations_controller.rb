        ...
        if resource.persisted?
            if resource.active_for_authentication?
                if resource.activated?
                    ...
                    flash[:warning] = "You have signed up, but your account is not activated. Click <a href=\"#{user_profile_show_path(resource.profile, section: 'requirements')}\" class=\"alert-link\">here</a> to activate your account.".html_safe
                end
